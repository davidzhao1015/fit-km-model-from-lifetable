This project addresses a key need we encountered in the IIM project: constructing a Kaplan–Meier curve and survival model using only a published life table.
